 ...
 * @returns string
 */
export const fnameToBname = (fname) => path.parse(fname).name;
/**
 ...
 */
export const bnameTofname = (bname, ext = "csv") => `${bname}.${ext}`;
/**
 ...
 */
export const pgDateToJs = (date) => new Date(date.replace(/['"]+/g, ""));
 ...
 * @returns {@link NumStr}
 */
export const getEdgeLabel = (data) => {
 ...
 * @returns
 */
export const getVertexLabel = (data) => {
    if (!data.length)
 ...
 * @returns
 */
export const getLabel = (type) => type === "v" ? getVertexLabel : getEdgeLabel;
/**
 ...
 * @returns
 */
export const recordsCreatedHandler = (result) => result.reduce((p, c) => {
